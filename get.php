...
if (($con = mysqli_connect($dbhost, $dbuser_get, $dbpass_get,$db)) === FALSE)
{
	error_message("Could not connect to the database: " . htmlspecialchars(mysqli_error($con)) . "
...
if (!$result)
{
	error_message("Could not query the database: " . htmlspecialchars(mysqli_error($con)). "<br>Cannot proceed.", 500);
}
